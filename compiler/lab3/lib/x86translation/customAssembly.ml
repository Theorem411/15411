...
let get_arrayalloc_function memErrLabel =
  ...
  ; X86.Test
      { rhs = X86.Reg { reg = R.RSI; size = 4 }
      ; lhs = X86.Reg { reg = R.RSI; size = 4 }
      ; size = X86.L
      }
  ...
  ; X86.BinCommand
      { op = X86.Movsl
      ; src = X86.Reg { reg = R.RSI; size = 4 }
      ; dest = X86.Reg { reg = R.RCX; size = 8 }
      ; size = X86.Q
      }
  ; X86.Test
  ...
  ; X86.BinCommand
      { op = X86.IMul
      ; dest = X86.Reg { reg = R.RDI; size = 8 }
      ; src = X86.Reg { reg = R.RCX; size = 8 }
      ; size = X86.Q
      }
  ; X86.Lea
      { dest = X86.Reg { reg = R.ESI; size = 8 }
  ...
  ; X86.BinCommand
      ...
      ; src = X86.Imm (Int64.of_int_exn 8)
      }
  ; X86.Call "calloc@plt"
  ; X86.BinCommand
      { op = X86.Add
